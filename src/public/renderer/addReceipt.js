...
const calculateFreightValueFromProduct = () => {
    ...
    console.log('Amount is ', totalBags, totalWeight, weightUnit, packetUnit);
...
const calculateTotalAmount = () => {
    ...
    let calculatedOp = calculateTotalAndPayableAmount(totalAmt, advanceAmt)
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        document.getElementById('lrPrefix').innerHTML = "SBR";
        document.getElementById('prefix').value = "SBR";
    ...
    addReceiptForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if(addReceiptResponse.errCode == 2000) {
                ...
                // * TODO- Print Feature
                printBtn.setAttribute('onclick', `printPage(${receiptDetails.id})`);
